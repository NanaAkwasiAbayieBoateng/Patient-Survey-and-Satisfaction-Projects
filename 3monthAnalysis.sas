...
diffsumptinfo diffPWB diffSWB diffEWB diffFWB diffLCS diffFACTL diffFACTG diffTOI diffsumcgphyscomm7 diffsumcgbarriers diffFinancialburden diffHADS_d diffHADS_a;
